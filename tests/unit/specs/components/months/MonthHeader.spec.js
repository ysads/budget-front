...
describe('MonthHeader', () => {
  ...
  it('renders prev button', () => {
    ...
    const item = wrapper.findComponent("[data-test='prev']");
  ...
  it('renders next button', () => {
    const wrapper = factory();
    const item = wrapper.findComponent("[data-test='next']");
  ...
  describe('when prev button is clicked', () => {
    it('emits update with previous month as payload', async () => {
      ...
      await wrapper.findComponent("[data-test='prev']").vm.$emit('click');
  ...
  describe('when next button is clicked', () => {
    it('emits update with next month as payload', async () => {
      ...
      await wrapper.findComponent("[data-test='next']").vm.$emit('click');
